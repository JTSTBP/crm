...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
    ...
    const menuItems = [
        ...
        { icon: <Activity size={20} />, label: 'Company Details', path: '/admin/leads' },
        { icon: <ClipboardCheck size={20} />, label: 'Company Approvals', path: '/admin/add-lead' },
        { icon: <Contact size={20} />, label: 'Contacts', path: '/admin/contacts' },
        ...
        { icon: <Send size={20} />, label: 'Email Sending', path: '/admin/email-sending' },
    ];
