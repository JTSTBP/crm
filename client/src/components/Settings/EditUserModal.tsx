...
import { X, Edit3, Mail, Phone, User, Shield } from 'lucide-react'
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
            ...
            <div className="text-sm text-gray-300 space-y-1">
              ...
              <p><strong>Manager:</strong> Team oversight, reports, lead management</p>
              <p><strong>BD Executive:</strong> Lead management, proposals, tasks</p>
            </div>
          </div>
